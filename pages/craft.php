    ...
    <div class="container">
        <section class="section">
            <div class="grid">
                <div class="col-12 col-sm-6 mb-4">
                    ...
                    <p>By replacing plastic products with jute alternatives, the program contributes to a healthier
                        environment while creating sustainable income opportunities for artisans, especially women and
                        marginalized groups from tribal communities.</p>
        ...
        <section id="training" class="section">
            ...
            <div class="card shadow p-4 mt-5">
                <h3 class="mb-3">Training Process</h3>
                <div class="timeline">
                    <div class="timeline-item left">
                        <div class="timeline-content">
                            <h4>Foundation Course</h4>
                            <p>Introduction to jute as a material, basic stitching techniques, and tool handling.</p>
                        </div>
                    </div>
                    <div class="timeline-item right">
                        <div class="timeline-content">
                            <h4>Advanced Techniques</h4>
                            <p>Specialized stitching methods, pattern creation, and product diversification.</p>
                        </div>
                    </div>
                    <div class="timeline-item left">
                        <div class="timeline-content">
                            <h4>Quality Control</h4>
                            <p>Learning quality standards, finishing techniques, and product durability enhancement.</p>
                        </div>
                    </div>
                    <div class="timeline-item right">
                        <div class="timeline-content">
                            <h4>Market Readiness</h4>
                            <p>Understanding market trends, pricing strategies, and customer preferences.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="products" class="section">
            ...
            <div class="text-center mt-5">
                <a href="#" class="btn btn-accent">View Product Catalog</a>
            </div>
        </section>
        ...
        <section class="section bg-light p-5 rounded">
            <div class="grid">
                <div class="col-12 col-sm-8">
                    ...
                    <p>We also welcome partnerships with businesses interested in sustainable corporate gifts or bulk
                        orders of eco-friendly products.</p>
                </div>
                <div class="col-12 col-sm-4 d-flex align-items-center justify-content-center">
                    <a href="<?= BASE_URL ?>pages/make_difference.php" class="btn btn-accent btn-lg">Get Involved</a>
                </div>
            </div>
        </section>
        ...
        <section class="section">
            ...
            <div class="grid">
                <div class="col-12 col-sm-6 mb-4">
                    <div class="testimonial">
                        <div class="testimonial-content">
                            "The training I received at JSVK's Craft & Jute Creations center has transformed my life. I
                ...
                <div class="col-12 col-sm-6 mb-4">
                    <div class="testimonial">
                        <div class="testimonial-content">
                            "As a tribal woman with limited opportunities, the jute crafting program opened new doors
                            for me. I'm proud that my products are not only providing me with financial independence but
