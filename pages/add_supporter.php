...
<head>
    ...
    <title>Add Supporter - JSVK Admin</title>
...
<body>
        ...
        <div class="d-flex align-items-center">
            <div class="logo">
                ...
                <div class="header-text">
                    <h1 style="margin: 0; font-size: 1.2rem;">Add New Supporter</h1>
                </div>
            </div>
        </div>
        <div>
    ...
    <div class="container mt-4">
        <div class="form-container">
            <form action="save_supporter.php" method="post" enctype="multipart/form-data" id="supporterForm">
                <div class="mb-4">
                    <label for="name" class="form-label">Supporter Name</label>
                    <input type="text" class="form-control" id="name" name="name" required>
                </div>

                <div class="mb-4">
                    <label for="type" class="form-label">Supporter Type</label>
                ...
                <div class="mb-4">
                    ...
                    <div class="form-text">Supported formats: Images (JPG, PNG)</div>
                    <div class="media-preview" id="logoPreview"></div>
                </div>

                <div class="mb-4">
                    <label for="media" class="form-label">Upload Additional Media</label>
                    <div class="input-group">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Save Supporter
                    </button>
    ...
    <script>
            ...
            if (file) {
                ...
                reader.onload = function (e) {
                    previewItem.innerHTML = `
                        ...
                        <span class="remove-preview" onclick="removeLogo()">
        ...
        document.getElementById('supporterForm').addEventListener('submit', function () {
