...
$total_query = "SELECT COUNT(*) as total FROM volunteer_application";
$total_result = $conn->query($total_query);
$total_applications = $total_result->fetch_assoc()['total'];
$total_pages = ceil($total_applications / $per_page);

$query = "SELECT * FROM volunteer_application ORDER BY created_at DESC LIMIT ? OFFSET ?";
...
<head>
    ...
    <title>Manage Volunteer Applications - JSVK Admin</title>
        ...
        <div class="d-flex align-items-center">
            <div class="logo">
                ...
                <div class="header-text">
                    <h1 style="margin: 0; font-size: 1.2rem;">Manage Volunteer Applications</h1>
                </div>
            </div>
        </div>
        <div>
                            ...
                            <tbody>
                                <?php while ($application = $applications->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-<?= htmlspecialchars($application['area_of_interest']) ?>">
                                                <?= ucfirst(htmlspecialchars($application['area_of_interest'])) ?>
                                            </span>
                                        </td>
