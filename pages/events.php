        ...
        <div class="events-grid">
            ...
            <div class="event-card" data-category="past">
                ...
                <div class="event-content">
                    ...
                    <p class="event-excerpt">Celebration of academic excellence rewarding top-performing students with school fee sponsorships from generous donors.</p>
            ...
            <div class="event-card" data-category="past">
                ...
                <div class="event-content">
                    ...
                    <p class="event-excerpt">Honoring the dedication and contributions of our educators with special performances and student-led activities.</p>
                    <a href="#" class="btn btn-primary">View Details</a>
                </div>
            </div>
            ...
            <div class="event-card" data-category="upcoming">
                ...
                <div class="event-content">
                    ...
                    <p class="event-excerpt">A day of fun, games, and bonding activities across all centers to make our children feel special and celebrated.</p>
                    <a href="#" class="btn btn-primary">View Details</a>
                </div>
            </div>
            ...
            <div class="event-card" data-category="upcoming">
                ...
                <div class="event-content">
                    ...
                    <p class="event-excerpt">A joyful gathering with games, food, and cultural performances to bring together students, parents, and the local community.</p>
                    <a href="#" class="btn btn-primary">View Details</a>
                </div>
            </div>
