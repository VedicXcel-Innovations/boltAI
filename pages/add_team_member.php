...
<head>
    ...
    <title>Add Team Member - JSVK Admin</title>
...
<body>
        ...
        <div class="d-flex align-items-center">
            <div class="logo">
                ...
                <div class="header-text">
                    <h1 style="margin: 0; font-size: 1.2rem;">Add New Team Member</h1>
                </div>
            </div>
        </div>
        <div>
    ...
    <div class="container mt-4">
        <div class="form-container">
            <form action="save_team_member.php" method="post" enctype="multipart/form-data" id="teamMemberForm">
                <div class="mb-4">
    ...
    <script>
        ...
        document.getElementById('teamMemberForm').addEventListener('submit', function () {
