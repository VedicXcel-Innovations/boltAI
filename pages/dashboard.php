...
<body>
    ...
    <div class="dashboard-sidebar">
        <ul>
            <li><a href="<?= BASE_URL ?>pages/dashboard.php" target="_blank" class="active"><i
                        class="fas fa-tachometer-alt"></i> Dashboard</a></li>
            <li><a href="<?= BASE_URL ?>pages/meet_team.php" target="_blank"><i class="fas fa-users"></i> Meet Our
                    Team</a></li>
            <li><a href="<?= BASE_URL ?>pages/supporters.php" target="_blank"><i class="fas fa-hands-helping"></i> Our
                    Supporters</a></li>
            <li><a href="<?= BASE_URL ?>pages/articles.php" target="_blank"><i class="fas fa-newspaper"></i>
                    Articles</a></li>
            <li><a href="<?= BASE_URL ?>pages/media_coverage.php" target="_blank"><i class="fas fa-image"></i> Media &
                    Coverage</a></li>
