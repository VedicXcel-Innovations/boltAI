...
<main>
    <section class="hero bg-primary">
        <div class="container">
            <h1>Our Programs</h1>
            <p>Discover the initiatives that drive our mission and create lasting impact</p>
        </div>
    </section>
                    ...
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <p>JSVK operates CCIs in Jamtara and Saraikela Kharsawan districts under the Mission
                                ...
                                vulnerable children, offering education, health services, counseling, and vocational
                                training.</p>
                            <div class="mt-3">
                                <strong>Impact:</strong> Over 100 children have successfully transitioned into
                                mainstream society, showcasing improved educational and psychological outcomes.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <p>This initiative empowers rural artisans by providing them with the skills needed to
                                ...
                                stitching, and quality control.</p>
                            <div class="mt-3">
                                <strong>Impact:</strong> Over 120 artisans have been trained, leading to increased
                                income and reduced plastic usage.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <p>Focused on empowering tribal women, these workshops provide hands-on training in jute
                                ...
                                them to earn a sustainable livelihood.</p>
                            <div class="mt-3">
                                <strong>Impact:</strong> Over 30 tribal women have enhanced their economic self-reliance
                                and reduced dependence on seasonal work.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <p>Under this scheme, JSVK has developed comprehensive village plans for 52 tribal villages.
                                ...
                                development.</p>
                            <div class="mt-3">
                                <strong>Impact:</strong> Over 15,000 individuals now have better access to water and
                    ...
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <p>JSVK's health programs focus on hygiene education and infrastructure development, such as
                                ...
                                community-led sanitation initiatives.</p>
                            <div class="mt-3">
                                <strong>Impact:</strong> Health outcomes for over 5,000 households have significantly
                                improved.
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 mb-4">
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <div class="mt-3">
                                <strong>Impact:</strong> Over 10,000 individuals have benefitted from these humanitarian
                                programs.
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 mb-4">
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <div class="mt-3">
                                <strong>Impact:</strong> Over 1,000 households participated, promoting unity and pride.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 mb-4">
                    <div class="card shadow h-100">
                        <div class="p-4">
                            ...
                            <div class="mt-3">
                                <strong>Impact:</strong> 20,000 trees have been planted, and plastic usage has decreased
                                in five districts.
                            </div>
                        </div>
                    </div>
